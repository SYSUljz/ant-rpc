...
struct ServerMetrics {
  ant_rpc::metrics::Counter accepted_connections;
  ant_rpc::metrics::Counter rejected_connections;
  ant_rpc::metrics::Counter closed_connections;
  // A complete, valid RPC_REQUEST frame reached ServerConnection.
  ant_rpc::metrics::Counter requests_received;
  ...
  ant_rpc::metrics::Counter requests_rejected_overload;
  // A response was accepted into ServerConnection's serialized write queue.
  ant_rpc::metrics::Counter responses_enqueued;
  // An asynchronous socket write failed after a response was queued.
  ant_rpc::metrics::Counter write_errors;
  // A write completion made forward progress but left bytes in the same frame.
  ant_rpc::metrics::Counter partial_write_completions;
  ant_rpc::metrics::Counter protocol_errors;

  ant_rpc::metrics::Gauge active_connections;
  ant_rpc::metrics::Gauge active_in_flight;
  // Accepted service tasks which have not begun worker execution yet.
  ant_rpc::metrics::Gauge pending_worker_tasks;
  ...
  ant_rpc::metrics::Gauge io_command_backlog;

  ant_rpc::metrics::LatencyRecorder request_latency;
 ...
 private:
  ...
  std::array<ant_rpc::metrics::Counter, static_cast<std::size_t>(ConnectionCloseReason::kCount)>
