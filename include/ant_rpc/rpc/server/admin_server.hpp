...
#include "ant_rpc/rpc/server/rpc_server.hpp"
...
class AdminServerState final : public ServerObserver, public std::enable_shared_from_this<AdminServerState> {
 public:
  ...
  ant_rpc::metrics::MetricRegistry registry {"ant_custom_"};
...
class AdminServer {
 public:
  ...
  [[nodiscard]] ant_rpc::metrics::MetricRegistry& Registry() noexcept { return state_->registry; }
