...
#include "ant_rpc/context/socket_handle.hpp"
#include "ant_rpc/type.hpp"
#include "butil/iobuf.h"
#if defined(ANT_RPC_ENABLE_TEST_SOCKET_FAULT_INJECTION)
#include "ant_rpc/testing/socket_fault_injector.hpp"
#endif

namespace ant_rpc::epoll_detail {
class BaseAwaiter;
struct CancelAnchor {
...
class EpollReadAwaiter final : public ant_rpc::epoll_detail::BaseAwaiter {
 public:
  ...
  bool await_suspend(std::coroutine_handle<Promise> coroutine) {
    ...
    ant_rpc::epoll_detail::SetNonBlocking(socket.value);
    if (target) {
...
class EpollWriteAwaiter final : public ant_rpc::epoll_detail::BaseAwaiter {
 public:
...
class EpollIOBufWriteAwaiter final : public ant_rpc::epoll_detail::BaseAwaiter {
 public:
...
#if defined(ANT_RPC_ENABLE_TEST_SOCKET_FAULT_INJECTION)
    max_bytes = ant_rpc::testing::SocketFaultInjector::MaxWriteBytes();
#endif
